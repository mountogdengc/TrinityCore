...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_LOAD_LOCALES,
    CONFIG_INVENTORY_AUTHENTICATOR_BACKPACK_SLOTS,
    CONFIG_COLLECTIONS_GRANT_PURCHASABLE_MOUNTS,
    CONFIG_COLLECTIONS_GRANT_ALL_TOYS,
    CONFIG_COLLECTIONS_GRANT_ALL_HEIRLOOMS,
    CONFIG_COLLECTIONS_GRANT_ALL_APPEARANCES,
    CONFIG_COLLECTIONS_GRANT_ALL_WARBAND_SCENES,
    CONFIG_CHARACTER_CREATING_UNLOCK_ALL_RACES,
