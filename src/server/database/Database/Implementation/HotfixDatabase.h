...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_ASSISTED_COMBAT,
    HOTFIX_SEL_ASSISTED_COMBAT_MAX_ID,

    HOTFIX_SEL_ASSISTED_COMBAT_RULE,
    HOTFIX_SEL_ASSISTED_COMBAT_RULE_MAX_ID,

    HOTFIX_SEL_ASSISTED_COMBAT_STEP,
    HOTFIX_SEL_ASSISTED_COMBAT_STEP_MAX_ID,
    ...
    HOTFIX_SEL_TRANSMOG_OUTFIT_ENTRY_MAX_ID,
    HOTFIX_SEL_TRANSMOG_OUTFIT_ENTRY_LOCALE,

    HOTFIX_SEL_TRANSMOG_OUTFIT_SLOT_INFO,
    HOTFIX_SEL_TRANSMOG_OUTFIT_SLOT_INFO_MAX_ID,

    HOTFIX_SEL_TRANSMOG_OUTFIT_SLOT_OPTION,
    HOTFIX_SEL_TRANSMOG_OUTFIT_SLOT_OPTION_MAX_ID,
    HOTFIX_SEL_TRANSMOG_OUTFIT_SLOT_OPTION_LOCALE,
    ...
    HOTFIX_SEL_TRANSMOG_SITUATION_MAX_ID,
    HOTFIX_SEL_TRANSMOG_SITUATION_LOCALE,

    HOTFIX_SEL_TRANSMOG_SITUATION_GROUP,
    HOTFIX_SEL_TRANSMOG_SITUATION_GROUP_MAX_ID,

    HOTFIX_SEL_TRANSMOG_SITUATION_TRIGGER,
    HOTFIX_SEL_TRANSMOG_SITUATION_TRIGGER_MAX_ID,
    HOTFIX_SEL_TRANSMOG_SITUATION_TRIGGER_LOCALE,
